...
interface PdfToolbarProps {
    ...
    /** PDF dark mode: invert PDF canvas for comfortable reading in low light. */
    pdfDarkMode?: boolean;
...
export function PdfToolbar({
    ...
    const currentColorConfig =
        HIGHLIGHT_COLOR_SWATCHES.find((c) => c.color === highlightColor) ||
        HIGHLIGHT_COLOR_SWATCHES[2];
    return (
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            <Highlighter size={16} />
                            <div
                                className={`w-3.5 h-3.5 rounded-sm ${currentColorConfig.bg}`}
                            />
                        </Button>
                    </DropdownMenuTrigger>
            ...
            <div className="hidden md:flex items-center gap-3">
                ...
                {onToggleReadMode && (
                    <Button
                        ...
                        aria-label={
                            isReadMode ? "Exit focus mode" : "Focus mode"
                        }
                    >
                        {isReadMode ? (
                            <Minimize2 size={16} />
                ...
                {onTogglePdfDarkMode && (
                    <Button
                        ...
                        title={pdfDarkMode ? "Light PDF" : "Dark PDF"}
                        aria-label={pdfDarkMode ? "Light PDF" : "Dark PDF"}
                    >
