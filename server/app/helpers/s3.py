...
class S3Service:
    ...
    def generate_presigned_url(
        ...
        try:
            ...
            # When using a custom S3-compatible endpoint (e.g. Cloudflare R2),
            # the presigned URL is already correct — no host rewriting needed.
            # Only rewrite when we're talking to real AWS S3.
